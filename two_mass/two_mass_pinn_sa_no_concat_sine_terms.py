...
class PhysicsInformedNN(object):
    ...
    def calc_physics_loss(self, x_col, epoch): # changed to sqauring weights and loss before multiplying
...
def main():
    ...
    experiment_name = "two_mass_sa_terms_fixeds_no_conc_sin_bigcomp_h_l_" + str(hidden_layers) + "_w_" + str(
    ...
    pinn.physics_scale2 = tf.cast(1e-6, tf.float32)
