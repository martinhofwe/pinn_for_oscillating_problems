...
times = []
l2_error_lbfgs = []
def lbfgs(opfunc, x, state, maxIter = 100, learningRate = 1, l2_error_function=None, x_star=None, u_star=None,  do_verbose = True):
  ...
  while nIter < maxIter:
    ...
    if do_verbose:
      ...
      #if nIter % 100 == 0:
      l2_error_lbfgs.append(l2_error_function(x_star, u_star))
  ...
  return x, f_hist, currentFuncEval, l2_error_lbfgs
