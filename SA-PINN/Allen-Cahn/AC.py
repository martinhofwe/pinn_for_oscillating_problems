...
experiment_name = "ac_" + af_str + "n0_" +str(num_n0_points) + "_"  + str(task_id)
...
#plt.plot(np.arange(0, train_iter+n_iter,10), l2_error_lst, label='l2 error')
